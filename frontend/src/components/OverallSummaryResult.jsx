                ...
                <div className={`bg-${colors.secondary} p-4 rounded-lg text-center`}>
                    ...
                    <p className="text-3xl font-bold text-green-400">
                        {results.overall.attemptedCount ?
                            Math.round(((results.overall.correctMCQ + results.overall.correctNumerical) /
            ...
            <div className={`bg-${colors.secondary} p-4 rounded-lg`}>
                ...
                <ResponsiveContainer width="100%" height={300}>
                    ...
                    >
                        ...
                        <Legend />
                        <Bar dataKey="score" name="Your Score" fill={examType === 'NEET' ? '#3498DB' : '#3B82F6'} />
                    ...
                    <ul className={`space-y-1 bg-${colors.secondary} p-3 rounded-lg`}>
                        <li className="flex justify-between">
                            ...
                            <span className="text-green-400">
                                ...
                                (+{(results.overall.correctMCQ + results.overall.correctNumerical) * results.overall.scoringRule.correctMCQMarks})
                            </span>
                        </li>
                        <li className="flex justify-between">
                            <span>Incorrect Answers:</span>
                            <span className={results.overall.scoringRule.incorrectMCQMarks < 0 ? "text-red-400" : "text-yellow-400"}>
                                {results.overall.incorrectMCQ + results.overall.incorrectNumerical}
                                {results.overall.scoringRule.incorrectMCQMarks < 0 ?
                                    `(${results.overall.incorrectMCQ * results.overall.scoringRule.incorrectMCQMarks})` :
                                    "(0)"
                                }
                            </span>
                        </li>
