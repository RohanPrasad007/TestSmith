    ...
    <div className="flex justify-center w-full mt-[10%] h-[70%] ">
      <div className="bg-white/5 text-white p-6 rounded-xl shadow-lg  text-center w-full text-xl">
        ...
        <div className="bg-black p-4 py-8 rounded-md mb-4">
          <p className="text-3xl font-medium text-gray-500 mb-8">
            Exam Details
          </p>
          <p className="text-white mb-4">
            <strong>Subjects:</strong> {currentExam.subjects}
          </p>
          <p className="text-white mb-4">
            <strong>Duration:</strong> {currentExam.duration}
          </p>
          <p className="text-white mb-4">
            <strong>Question Type:</strong> {currentExam.questionTypes}
          </p>
        </div>
